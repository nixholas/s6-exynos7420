...
enum opt_code
{
  ...
  OPT_mcpu_ = 1070,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1071,         /* -mfix-cortex-a53-835769 */
  ...
  /* OPT_std_c__14 = 1131, */                /* -std=c++14 */
  OPT_std_c__1y = 1132,                      /* -std=c++1y */
  OPT_std_c__98 = 1133,                      /* -std=c++98 */
  OPT_std_c11 = 1134,                        /* -std=c11 */
  /* OPT_std_c1x = 1135, */                  /* -std=c1x */
  /* OPT_std_c89 = 1136, */                  /* -std=c89 */
  OPT_std_c90 = 1137,                        /* -std=c90 */
  OPT_std_c99 = 1138,                        /* -std=c99 */
  /* OPT_std_c9x = 1139, */                  /* -std=c9x */
  OPT_std_f2003 = 1140,                      /* -std=f2003 */
  OPT_std_f2008 = 1141,                      /* -std=f2008 */
  OPT_std_f2008ts = 1142,                    /* -std=f2008ts */
  OPT_std_f95 = 1143,                        /* -std=f95 */
  OPT_std_gnu = 1144,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1145, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1146, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1147,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1148, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1149,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1150,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1151,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1152, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1153, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1154,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1155,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1156, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1157, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1158,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1159, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1160, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1161, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1162,                     /* -std=legacy */
  OPT_symbolic = 1163,                       /* -symbolic */
  OPT_t = 1164,                              /* -t */
  OPT_time = 1165,                           /* -time */
  OPT_time_ = 1166,                          /* -time= */
  OPT_traditional = 1167,                    /* -traditional */
  OPT_traditional_cpp = 1168,                /* -traditional-cpp */
  OPT_trigraphs = 1169,                      /* -trigraphs */
  OPT_u = 1170,                              /* -u */
  OPT_undef = 1171,                          /* -undef */
  OPT_v = 1172,                              /* -v */
  OPT_version = 1173,                        /* -version */
  OPT_w = 1174,                              /* -w */
  OPT_wrapper = 1175,                        /* -wrapper */
  OPT_x = 1176,                              /* -x */
  OPT_z = 1177,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
